...
- **THEN** system creates student profile and initializes with default study preferences

#### Scenario: Add subjects to profile
- **WHEN** user clicks "Add Subjects" and selects Math, Biology, English
- **THEN** system stores selected subjects in student profile for task organization
