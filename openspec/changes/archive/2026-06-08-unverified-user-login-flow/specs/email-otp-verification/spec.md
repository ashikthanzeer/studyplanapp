...
- **THEN** the system SHALL update the user's password, mark the user account as verified, delete the OTP, and display a success message allowing them to log in.
